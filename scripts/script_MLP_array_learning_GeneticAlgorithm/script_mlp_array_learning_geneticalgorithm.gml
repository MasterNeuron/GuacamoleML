...
/// @func	___mlp_array_genetic_algorithm(population, elitism, mutationism, mutationRate);
...
function ___mlp_array_genetic_algorithm(population, elitism, mutationism, mutationAmount, mutationRate) {
