/// @func	draw_mlp_grid(mlp, sprite, xStart, yStart, scale);
/// @desc	Draws MLP with 'snake' representation, clearly showing individual weights*outputs
/// @param	{MLP}		mlp		neural network to be drawn
/// @param	{sprite}	sprite	For drawing neurons and weights
/// @param	{real}		xStart	
/// @param	{real}		yStart
/// @param	{real}		scale
function draw_mlp_grid(mlp, sprite, xStart, yStart, scale) {
